...
BuildRequires: symb-devel          = 1.6.13-4.git.8917919%{?dist}
BuildRequires: vmi5588-devel       = 1.3-1.git.7516a55%{?dist}
...
Requires: symb-devel       = 1.6.13-4.git.8917919%{?dist}
Requires: vmi5588-devel    = 1.3-1.git.7516a55%{?dist}
%description devel
This is the module %{name}.
